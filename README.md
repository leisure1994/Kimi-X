...
[👉 点这里下载 kimix-agent-v0.90.zip](https://github.com/leisure1994/Kimi-X/archive/refs/heads/master.zip)
...
**Q：GitHub 下载不了 ZIP？**
A：从飞书聊天记录里下载我发的 `kimix-agent-v0.90.zip`，内容完全一样。
